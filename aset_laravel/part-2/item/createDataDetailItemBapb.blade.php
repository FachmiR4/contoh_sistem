    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item">
                    <a href="">Data Barang BAPB</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Tambah Data Detail Barang BAPB</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        <ul class="nav nav-tabs nav-fill w-100 mb-3" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button
                    ...
                    aria-selected="true"
                >
                    <i class="bi bi-plus-lg me-1"></i> Add Detail Barang
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button
                    ...
                    aria-selected="false"
                >
                    <i class="bi bi-table me-1"></i> List Detail Barang
                </button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            ...
            >
                @include('pages.bapb.item.partials.formDataDetailBarang')
            </div>
            <div
                class="tab-pane fade"
                id="tab-2"
            ...
            >
                <div class="p-3">
                    @include('pages.bapb.item.partials.tablesDataDetailItemBapb')
                </div>
            </div>
        </div>
...
<script>
    @if(session('active_tab'))
        localStorage.setItem('lastActiveTab', '{{ session('active_tab') }}');
    @endif
